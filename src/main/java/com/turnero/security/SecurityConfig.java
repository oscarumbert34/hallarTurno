    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/businesses/*/customer-contacts/search").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/public/assets/logo-hallarturno.svg").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/public/businesses/**").permitAll()
