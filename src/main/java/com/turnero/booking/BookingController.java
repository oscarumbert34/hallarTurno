...
public class BookingController {
    ...
    public BookingResponse reschedule(
        ...
        return bookingService.reschedule(id, request, currentUser);
    }

    @PatchMapping("/bookings/{id}/deposit-status")
    public BookingResponse updateDepositStatus(
            @PathVariable UUID id,
            @Valid @RequestBody BookingDepositStatusRequest request,
            @AuthenticationPrincipal AuthenticatedUser currentUser
    ) {
        return bookingService.updateDepositStatus(id, request, currentUser);
    }
    ...
    public BookingPageResponse findByBusiness(
        ...
        return bookingService.findByBusiness(
                businessId,
                currentUser,
                page,
                size,
